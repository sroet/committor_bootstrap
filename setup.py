...
def write_version_py(filename='committor_bootstrap/version.py'):
    cnt = """
...
def buildKeywordDictionary():
    ...
    setupKeywords = {}
    setupKeywords["name"]              = "committor_bootstrap"
    ...
    setupKeywords["packages"]          = ['committor_bootstrap',
                                          'committor_bootstrap.tests']
    setupKeywords["package_dir"]       = {
        'committor_bootstrap' : 'committor_bootstrap',
        'committor_bootstrap.tests' : 'committor_bootstrap/tests'
    }
